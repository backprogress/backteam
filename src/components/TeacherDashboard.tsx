...
export function TeacherDashboard({ posts, profiles }: TeacherDashboardProps) {
  ...
  return (
    <section className="rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 p-5 shadow-sm">
      <h2 className="mb-3 text-lg font-semibold text-slate-900 dark:text-slate-100">교사 통계 대시보드</h2>
      <div className="grid gap-3 md:grid-cols-3">
        <article className="rounded-lg bg-slate-50 dark:bg-slate-700 p-3">
        ...
        <article className="rounded-lg bg-slate-50 dark:bg-slate-700 p-3">
          <p className="text-sm text-slate-500 dark:text-slate-400">활동 학생</p>
          <p className="text-2xl font-bold text-slate-900 dark:text-slate-100">{studentProfiles.length}명</p>
        </article>
        <article className="rounded-lg bg-slate-50 dark:bg-slate-700 p-3">
          <p className="text-sm text-slate-500 dark:text-slate-400">활성 공고</p>
      ...
      <div className="mt-4 rounded-lg border border-slate-200 dark:border-slate-700 p-3">
        <p className="mb-2 text-sm font-semibold text-slate-700 dark:text-slate-300">학년별 활동 학생 수</p>
